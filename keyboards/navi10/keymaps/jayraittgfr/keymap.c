...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(/* Base, media and arrow */
                 TD(TAPPY_KEY),C(KC_F),C(S(KC_V)),
                 C(KC_X),   C(KC_C),   C(KC_V),
                 
                            KC_UP,
                 KC_LEFT,   KC_DOWN,    KC_RIGHT),
    [_FN0] = LAYOUT(/* media layer, hold tappy*/
                 KC_TRNS,   KC_VOLD,   KC_VOLU,
                 KC_MRWD,   KC_MPLY,   KC_MFFD,
                 
                            KC_TRNS,
                 KC_TRNS,   KC_TRNS,   KC_TRNS),
    [_ML1] = LAYOUT(/* NX layer, toggled on a single tappy */
                 KC_TRNS,   KC_TRNS,   KC_TRNS, 
                 C(KC_E),   C(KC_M),   C(S(KC_D)),
